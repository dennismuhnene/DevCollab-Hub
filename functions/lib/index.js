...
exports.onNewEngagementMessage = exports.onEngagementUpdated = exports.onEngagementCreated = exports.setAdvisorVerificationStatus = exports.onUserAccountDeleted = exports.deleteUserAccount = void 0;
__exportStar(require("./generate-upload-url"), exports);
 ...
 */
exports.onEngagementCreated = functions.firestore
 ...
 */
exports.onEngagementUpdated = functions.firestore
    .document('engagements/{engagementId}')
    ...
    if (recipientId) {
        ...
        await notificationRef.set(Object.assign(Object.assign({}, notification), { read: false, createdAt: admin.firestore.FieldValue.serverTimestamp() }));
    }
    return null;
});
/**
 ...
 */
exports.onNewEngagementMessage = functions.firestore
