  ...
  return (
    <>
      ...
      <motion.div
        ...
        dragMomentum={false}
        className={cn(
          "fixed top-1/2 right-4 z-50 flex flex-col gap-4 items-center p-3 bg-card/50 backdrop-blur-sm border border-border/50 rounded-full cursor-grab active:cursor-grabbing",
          className
        )}
        style={{ y: '-50%' }}
      ...
      >
          <Grab className="h-6 w-6 text-foreground/80" />
        ...
        {icons.map((social, index) => (
          <motion.a
            ...
            className="p-2 text-foreground hover:bg-primary hover:text-primary-foreground rounded-full transition-colors duration-200"
