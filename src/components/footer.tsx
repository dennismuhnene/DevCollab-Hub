...
const NeuralAxisLogo = () => (
    <svg width="32" height="32" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-8 w-8">
        <g clipPath="url(#clip0_footer_logo)">
            ...
            <path d="M62.6375 29.1667L43.75 62.5H56.25L62.6375 52.0833V29.1667Z" fill="#F1B302"/>
