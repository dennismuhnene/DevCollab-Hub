...
import { doc, getDoc, onSnapshot, updateDoc, arrayUnion, arrayRemove, serverTimestamp, collection, addDoc, query, where, documentId, getDocs, deleteDoc, Timestamp } from 'firebase/firestore';
...
import { Hand, Edit, Trash2, Code, BrainCircuit, Clock, UserCheck, Handshake, Briefcase, MapPin, Users, Link as LinkIcon, UserPlus, UserX, MessageSquare, ExternalLink } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
           ...
           <Card>
                ...
                <CardContent>
                    <p className="text-foreground/80 leading-relaxed mt-2">{project.roleRequirements}</p>
                </CardContent>
            </Card>
